...
public void sendmail(UserTtm user ,Event event){
    try {
        ...
        String msgBody = "Je suis actuellement sur les lieux de l'événement, la vie de loser ne m'intéresse plus. "+url;
...
throws IOException {
    ...
    List<UserTtm> users = UserTtmRepository.getInstance().list();
